...
import Dopol_Form.otchet_kliyenty;
import Dopol_Form.otchet_sotrudnikov;
import Dopol_Form.otchet_zarplata;
import dolzhnosti.dolzhnosti;
...
public class Director extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Удаленная информация");
        ...
        jLabel2.setText("Добро пожаловать в систему Директора");
        ...
        jButton5.getAccessibleContext().setAccessibleParent(jLabel1);

        jMenu1.setText("Файл");

        jMenuItem1.setText("Действия по должностям");
        ...
        jMenuItem5.setText("Информация о сотрудниках");
        ...
        jMenuItem6.setText("Информация о зарплате");
        ...
        jMenuItem7.setText("Информация о клиентах");

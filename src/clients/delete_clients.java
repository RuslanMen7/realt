 ...
 * @author Asus
 */
public class delete_clients extends javax.swing.JFrame {

    /**
     * Creates new form delete_clients
     */
    public delete_clients() {
        ...
        try {
            ...
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM  cto_buryatia.klient ");
            int i = 0;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Удалить клиента");
        ...
        jMenuItem1.setText("Удалить клиента");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String data_obrsheniya = jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString();
        String nomer_telefona = jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString();
        ...
        try {
            ...
            String query = "INSERT INTO cto_buryatia.delet_klient (id_delet_klient,familiya, imya,otchestvo,nomer_telefona,data_obrasheniya)"+" VALUES (?,?,?,?,?,?)";
            ...
            String sql = "delete from cto_buryatia.klient where id_klient="+id_klient;
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        JOptionPane.showMessageDialog(null, "Для удаление клиента выдилите его в таблице нажмите кнопку удалить клиента. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_clients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_clients().setVisible(true);
            }
        });
    }

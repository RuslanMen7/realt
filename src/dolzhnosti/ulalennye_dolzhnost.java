 ...
 * @author Asus
 */
public class ulalennye_dolzhnost extends javax.swing.JFrame {

    /**
     * Creates new form ulalennye_dolzhnost
     */
    public ulalennye_dolzhnost() {
        initComponents();
        ...
        try {
            ...
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM  cto_buryatia.delet_doljn ");
            int i = 0;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Востоновить должность");
        ...
        jMenuItem2.setText("Востоновить должность");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int n = JOptionPane.showConfirmDialog(
            frame,
            "Вы дествительно хотите вернуть запись?",
            "",
        ...
        try {
            ...
            String query = "INSERT INTO cto_buryatia.doljn (id_doljn,name_doljn, oklad)"+" VALUES (?,?,?)";
            ...
            String sql = "delete from cto_buryatia.delet_doljn where id_delet_doljn="+id_doljn;
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        JOptionPane.showMessageDialog(null, "Для востановления должности выдилите его в таблице нажмите кнопку востановить должность. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ulalennye_dolzhnost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

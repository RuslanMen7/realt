 ...
 * @author Asus
 */
public class otchet_zarplata extends javax.swing.JFrame {

    /**
     * Creates new form otchet_zarplata
     */
    public otchet_zarplata() {
        initComponents();
        String[] columnNames = {"Номер зарплаты","Номер персонала", "Фамилия", "Имя", "Отчество", "Должность","Дата","Оклад","Доплата","Зарплата" };
        ...
        try {
            ...
            ResultSet resultSet = stmt.executeQuery("SELECT zarplata.id_zarplata,personal.id_personal, personal.familiya, personal.imya,"
                    + " personal.otchestvo,  doljn.name_doljn , zarplata.date, zarplata.oklad, zarplata.doplata, zarplata.zarplata_itog "
                    + "FROM cto_buryatia.personal, cto_buryatia.doljn , cto_buryatia.zarplata "
                    + "where doljn.id_doljn=personal.id_doljnosti and doljn.oklad=zarplata.oklad ");
            int i = 0;
    ...
    private void initComponents() {
        ...
        setTitle("Информация о зарплате");
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        JOptionPane.showMessageDialog(null, "На этой форме выведенна информация о заработной плате. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(otchet_zarplata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

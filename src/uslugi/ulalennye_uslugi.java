 ...
 * @author Asus
 */
public class ulalennye_uslugi extends javax.swing.JFrame {

    /**
     * Creates new form ulalennye_uslugi
     */
    public ulalennye_uslugi() {
        initComponents();
        ...
        try {
            ...
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM   cto_buryatia.delet_uslugi  ");
            int i = 0;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Востоновить услугу");
        ...
        jMenuItem2.setText("Востоновить услугу");
 ...
 if (jTable1.getSelectedRow()==-1){Component c = null;
        ...
        try {
            ...
            String query = "INSERT INTO cto_buryatia.uslugi(id_uslugi,name_uslugi, stoim,prodolj_raboti,id_personal)"+" VALUES (?,?,?,?,?)";
            ...
            String sql = "delete from cto_buryatia.delet_uslugi where id_delet_uslugi="+id_uslugi;
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        JOptionPane.showMessageDialog(null, "Для востановления услуги выдилите его в таблице нажмите кнопку востановить услугу. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ulalennye_uslugi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
